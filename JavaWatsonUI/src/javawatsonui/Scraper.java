...
public class Scraper {
	...
	public static HashSet<String> getIngredients(String url_recipe) throws UnsupportedEncodingException, IOException{
        ...
        String key = "key=7527bd8d097019d6b92b2e5fdc898748&q=";
...
//                        System.out.println(splitted[x + 1]);
    ...
    public static void main(String[] args) throws IOException {
    	for (String ing : ingredientsNeeded("http://allrecipes.com/recipe/221935/fish-tacos-ultimo/","food_database.csv","foods.zip")) {
